...
export function WoodLibraryEditor({ woods, onAdd, onUpdate, onDelete, onUse }: Props) {
  return <div className="wood-library-editor">
    <div className="panel-title-row"><div><h3>Wood library</h3><p>Custom species are saved in this workspace.</p></div><button className="icon-button" onClick={onAdd} aria-label="Add custom wood"><Plus/></button></div>
